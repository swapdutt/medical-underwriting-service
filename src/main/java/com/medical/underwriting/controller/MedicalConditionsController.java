...
public class MedicalConditionsController {
    ...
    public ResponseEntity<DiseaseQuestionnaireDto> findDiseaseQuestionnaireById (@RequestParam(value = "diseaseQuestionnaireId", required = false)
                                                                                @PathVariable("diseaseQuestionnaireId")
                                                                                @Nullable final String diseaseQuestionnaireId) {
    ...
    public ResponseEntity<LabTestsDto> findLabTestsById (@RequestParam(value = "labTestsId", required = false)
                                                        @PathVariable("labTestsId") @Nullable final String labTestsId) {
    ...
    public ResponseEntity<PersonalMedicalConditionsDto> findPersonalMedicalConditionsById (@RequestParam(value = "personalMedicalConditionsId", required = false)
                                                                                          @PathVariable("personalMedicalConditionsId")
                                                                                          @Nullable final String personalMedicalConditionsId) {
        return ResponseEntity.ok(medicalConditionsService.findPersonalMedicalConditionsById(personalMedicalConditionsId));
    }
    ...
    public ResponseEntity<DiseaseQuestionnaireDto> createDiseaseQuestionnaire (@RequestBody @Valid
                                                                                   @NonNull final DiseaseQuestionnaireDto diseaseQuestionnaireDto) {
        return new ResponseEntity<>(medicalConditionsService.createDiseaseQuestionnaire(diseaseQuestionnaireDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<LabTestsDto> createLabTests (@RequestBody @Valid
                                                          @NonNull final LabTestsDto labTestsDto) {
    ...
    public ResponseEntity<PersonalMedicalConditionsDto> createPersonalMedicalConditions (@RequestBody @Valid @NonNull
                                                                                             final PersonalMedicalConditionsDto personalMedicalConditionsDto) {
        return new ResponseEntity<>(medicalConditionsService.createPersonalMedicalConditions(personalMedicalConditionsDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<DiseaseQuestionnaireDto> updateDiseaseQuestionnaire (@RequestBody @Valid
                                                                                  @NonNull final DiseaseQuestionnaireDto diseaseQuestionnaireDto) {
    ...
    public ResponseEntity<LabTestsDto> updateLabTests (@RequestBody @Valid
                                                           @NonNull final LabTestsDto labTestsDto) {
    ...
    public ResponseEntity<PersonalMedicalConditionsDto> updatePersonalMedicalConditions (@RequestBody @Valid @NonNull
                                                                                             final PersonalMedicalConditionsDto personalMedicalConditionsDto) {
        return ResponseEntity.ok(medicalConditionsService.updatePersonalMedicalConditions(personalMedicalConditionsDto));
    }
    ...
    public ResponseEntity<?> deleteDiseaseQuestionnaireById (@RequestParam(value = "diseaseQuestionnaireId", required = false)
                                                            @PathVariable("diseaseQuestionnaireId")
                                                            @Nullable final String diseaseQuestionnaireId) {
    ...
    public ResponseEntity<?> deleteLabTestsById (@RequestParam(value = "labTestsId", required = false)
                                                @PathVariable("labTestsId") @Nullable final String labTestsId) {
    ...
    public ResponseEntity<?> deletePersonalMedicalConditionsById (@RequestParam(value = "personalMedicalConditionsId", required = false)
                                                                 @PathVariable("personalMedicalConditionsId")
                                                                 @Nullable final String personalMedicalConditionsId) {
