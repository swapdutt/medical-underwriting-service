...
public class MemberController {
    ...
    public ResponseEntity<MemberDetailsDto> findMemberDetailsById (@RequestParam(value = "memberDetailsId", required = false)
                                                                  @PathVariable("memberDetailsId") @Nullable final String memberDetailsId) {
    ...
    public ResponseEntity<LifestyleDetailsDto> findLifestyleDetailsById (@RequestParam(value = "lifestyleDetailsId", required = false)
                                                                        @PathVariable("lifestyleDetailsId") @Nullable final String lifestyleDetailsId) {
    ...
    public ResponseEntity<MedicalConditionsDetailsDto> findMedicalConditionsDetailsById (@RequestParam(value = "medicalConditionsDetailsId", required = false)
                                                                                        @PathVariable("medicalConditionsDetailsId")
                                                                                             @Nullable final String medicalConditionsDetailsId) {
    ...
    public ResponseEntity<MemberDetailsDto> createMemberDetails (@RequestBody @Valid @NonNull final MemberDetailsDto memberDetailsDto) {
    ...
    public ResponseEntity<LifestyleDetailsDto> createLifestyleDetails (@RequestBody @Valid @NonNull final LifestyleDetailsDto lifestyleDetailsDto) {
        return new ResponseEntity<>(memberDetailsService.createLifestyleDetails(lifestyleDetailsDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<MedicalConditionsDetailsDto> createMedicalConditionsDetails (@RequestBody @Valid @NonNull
                                                                                           final MedicalConditionsDetailsDto medicalConditionsDetailsDto) {
        return new ResponseEntity<>(memberDetailsService.createMedicalConditionsDetails(medicalConditionsDetailsDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<MemberDetailsDto> updateMemberDetails (@RequestBody @Valid @NonNull final MemberDetailsDto memberDetailsDto) {
    ...
    public ResponseEntity<LifestyleDetailsDto> updateLifestyleDetails (@RequestBody @Valid @NonNull final LifestyleDetailsDto lifestyleDetailsDto) {
    ...
    public ResponseEntity<MedicalConditionsDetailsDto> updateMedicalConditionsDetails (@RequestBody @Valid @NonNull
                                                                                      final MedicalConditionsDetailsDto medicalConditionsDetailsDto) {
    ...
    public ResponseEntity<?> deleteMemberDetailsById (@RequestParam(value = "memberDetailsId", required = false)
                                                     @PathVariable("memberDetailsId") @Nullable final String memberDetailsId) {
    ...
    public ResponseEntity<?> deleteLifestyleDetailsById (@RequestParam(value = "lifestyleDetailsId", required = false)
                                                        @PathVariable("lifestyleDetailsId") @Nullable final String lifestyleDetailsId) {
    ...
    public ResponseEntity<?> deleteMedicalConditionsById (@RequestParam(value = "medicalConditionsDetailsId", required = false)
                                                         @PathVariable("medicalConditionsDetailsId") @Nullable final String medicalConditionsDetailsId) {
