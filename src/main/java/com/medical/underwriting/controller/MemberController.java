...
public class MemberController {
    ...
    public ResponseEntity<LifestyleDetailsResponse> findLifestyleDetailsById(@PathVariable("lifestyleDetailsId") @Nullable final String lifestyleDetailsId) {
    ...
    public ResponseEntity<LifestyleDetailsResponse> createLifestyleDetails(@RequestBody @Valid @NonNull final CreateLifestyleDetailsRequestPayload payload) {
    ...
    public ResponseEntity<LifestyleDetailsResponse> updateLifestyleDetails(@PathVariable("lifestyleDetailsId") @Nullable final String lifestyleDetailsId,
    ...
    @Operation(summary = "Delete the record of lifestyle details by lifestyle details id")
    @ApiResponses(value = {
    ...
    public ResponseEntity<MedicalConditionsResponse> findMedicalConditionsDetailsById(@PathVariable("medicalConditionsDetailsId") @Nullable final String medicalConditionsDetailsId) {
    ...
    public ResponseEntity<MedicalConditionsResponse> createMedicalConditionsDetails(@RequestBody @Valid @NonNull final CreateMedicalConditionsRequestPayload payload) {
    ...
    public ResponseEntity<MedicalConditionsResponse> updateMedicalConditionsDetails(@PathVariable("medicalConditionsDetailsId") @Nullable final String medicalConditionsDetailsId,
    ...
    public ResponseEntity<MemberDetailsResponse> findMemberDetailsById(@PathVariable("memberDetailsId") @Nullable final String memberDetailsId) {
    ...
    public ResponseEntity<MemberDetailsResponse> createMemberDetails(@RequestBody @Valid @NonNull final CreateMemberDetailsRequestPayload payload) {
    ...
    public ResponseEntity<MemberDetailsResponse> updateMemberDetails(@PathVariable("memberDetailsId") @Nullable final String memberDetailsId,
