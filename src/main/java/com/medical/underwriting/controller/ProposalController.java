...
public class ProposalController {
	...
	public ResponseEntity<PaymentDetailsDto> findPaymentDetailsById(
			@RequestParam(value = "paymentDetailsId", required = false) @PathVariable("paymentDetailsId") @Nullable final Integer paymentDetailsId) {
	...
	public ResponseEntity<ProposerDetailsDto> findProposerDetailsById(
			@RequestParam(value = "proposerDetailsId", required = false) @PathVariable("proposerDetailsId") @Nullable final Integer proposerDetailsId) {
	...
	public ResponseEntity<ProposalDetailsDto> findProposalDetailsById(
			@RequestParam(value = "proposalDetailsId", required = false) @PathVariable("proposalDetailsId") @Nullable final Integer proposalDetailsId) {
	...
	public ResponseEntity<PaymentDetailsDto> createPaymentDetails(
			@RequestBody @Valid @NonNull final PaymentDetailsDto paymentDetailsDto) {
	...
	public ResponseEntity<ProposerDetailsDto> createProposerDetails(
			@RequestBody @Valid @NonNull final ProposerDetailsDto proposerDetailsDto) {
		return new ResponseEntity<>(proposalDetailsService.createProposerDetails(proposerDetailsDto),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<ProposalDetailsDto> createProposalDetails(
			@RequestBody @Valid @NonNull final ProposalDetailsDto proposalDetailsDto) {
		return new ResponseEntity<>(proposalDetailsService.createProposalDetails(proposalDetailsDto),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<ProposerDetailsDto> updateProposerDetails(
			@RequestBody @Valid @NonNull final ProposerDetailsDto proposerDetailsDto) {
	...
	public ResponseEntity<ProposalDetailsDto> updateProposalDetails(
			@RequestBody @Valid @NonNull final ProposalDetailsDto proposalDetailsDto) {
