...
public class ProposalController {
	...
	public ResponseEntity<PaymentDetailsResponse> findPaymentDetailsById(
	...
	public ResponseEntity<PaymentDetailsResponse> createPaymentDetails(
			@RequestBody @Valid @NonNull final CreatePaymentDetailsRequestPayload payload) {
	...
	public ResponseEntity<PaymentDetailsResponse> updatePaymentDetails(
			@RequestParam(value = "paymentDetailsId", required = false) @PathVariable("paymentDetailsId") @Nullable final String paymentDetailsId,
	...
	public ResponseEntity<ProposerDetailsResponse> findProposerDetailsById(
	...
	public ResponseEntity<ProposerDetailsResponse> createProposerDetails(
			@RequestBody @Valid @NonNull final CreateProposerDetailsRequestPayload paylaod) {
	...
	public ResponseEntity<ProposerDetailsResponse> updateProposerDetails(
			@RequestParam(value = "proposerDetailsId", required = false) @PathVariable("proposerDetailsId") @Nullable final String proposerDetailsId,
			@RequestBody @Valid @NonNull final UpdateProposerDetailsRequestPayload paylaod) {
	...
	public ResponseEntity<ProposalDetailsResponse> findProposalDetailsById(
	...
	public ResponseEntity<ProposalDetailsResponse> createProposalDetails(
			@RequestBody @Valid @NonNull final CreateProposalDetailsRequestPayload payload) {
