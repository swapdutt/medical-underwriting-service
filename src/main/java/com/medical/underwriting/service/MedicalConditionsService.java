...
public class MedicalConditionsService {
    ...
    public DiseaseQuestionnaireResponse createDiseaseQuestionnaire(CreateDiseaseQuestionnaireRequestPayload payload) {
        ...
        Optional<DiseaseQuestionnaire> diseaseQuestionnaire = diseaseQuestionnaireRepository.findDiseaseQuestionnaireByDiseaseQuestionnaireId(payload.getDiseaseQuestionnaireId());
        try {
            if (diseaseQuestionnaire.isEmpty()) {
                ...
                DiseaseQuestionnaire questionnaire = diseaseQuestionnaireRepository.save(underwritingMapper.createPayloadToDiseaseQuestionnaire(payload));
                log.info("Disease Questionnaire created : {}", questionnaire);
                return DiseaseQuestionnaireResponse.builder()
    ...
    public DiseaseQuestionnaireResponse updateDiseaseQuestionnaire(String diseaseQuestionnaireId, UpdateDiseaseQuestionnaireRequestPayload payload) {
        log.info("Inside updateDiseaseQuestionnaire with payload : {}", payload);
        Optional<DiseaseQuestionnaire> questionnaire = diseaseQuestionnaireRepository.findDiseaseQuestionnaireByDiseaseQuestionnaireId(diseaseQuestionnaireId);
        try {
            if (null != payload) {
    ...
    public void deleteDiseaseQuestionnaireById(String diseaseQuestionnaireId) {
        Optional<DiseaseQuestionnaire> diseaseQuestionnaire = diseaseQuestionnaireRepository.findDiseaseQuestionnaireByDiseaseQuestionnaireId(diseaseQuestionnaireId);
        log.info("Disease Questionnaire to delete : {}", diseaseQuestionnaire);
    ...
    public LabTestsResponse updateLabTests(String labTestsId, UpdateLabTestsRequestPayload payload) {
        log.info("Inside updateLabTests with payload : {}", payload);
        Optional<LabTests> labTests = labTestsRepository.findLabTestsByLabTestsId(labTestsId);
        try {
            if (null != payload) {
                log.info("Lab Tests before update : {}", labTests);
    ...
    public void deleteLabTestsById(String labTestsId) {
        Optional<LabTests> labTests = labTestsRepository.findLabTestsByLabTestsId(labTestsId);
        log.info("Lab Tests to delete : {}", labTests);
    ...
    public PersonalMedicalConditionsResponse findPersonalMedicalConditionsById(String personalMedicalConditionsId) {
        ...
        return PersonalMedicalConditionsResponse.builder()
                ...
                .diseaseQuestionnaire(findDiseaseQuestionnaireById(personalMedicalConditions.getDiseaseQuestionnaire().getDiseaseQuestionnaireId()))
    ...
    public PersonalMedicalConditionsResponse createPersonalMedicalConditions(CreatePersonalMedicalConditionsRequestPayload payload) {
        log.info("Inside createPersonalMedicalConditions with payload : {}", payload);
        Optional<PersonalMedicalConditions> personalMedicalConditions = personalMedicalConditionsRepository.findPersonalMedicalConditionsByPersonalMedicalConditionsId(payload.getPersonalMedicalConditionsId());
        try {
            if (personalMedicalConditions.isEmpty()) {
                if (null != payload.getPersonalMedicalConditionsId()) {
                    payload.setPersonalMedicalConditionsId(underwritingUtility.generateUUID());
                }
                PersonalMedicalConditions medicalConditions = personalMedicalConditionsRepository.save(underwritingMapper.createPayloadToPersonalMedicalConditions(payload));
                log.info("Personal Medical Conditions created : {}", medicalConditions);
                return PersonalMedicalConditionsResponse.builder()
                        .personalMedicalConditionsId(medicalConditions.getPersonalMedicalConditionsId())
                        .diseaseQuestionnaire(underwritingMapper.diseaseQuestionnaireEntityToResponse(medicalConditions.getDiseaseQuestionnaire()))
    ...
    public PersonalMedicalConditionsResponse updatePersonalMedicalConditions(String personalMedicalConditionsId, UpdatePersonalMedicalConditionsRequestPayload payload) {
        log.info("Inside updatePersonalMedicalConditions with payload : {}", payload);
        Optional<PersonalMedicalConditions> medicalConditions = personalMedicalConditionsRepository.findPersonalMedicalConditionsByPersonalMedicalConditionsId(personalMedicalConditionsId);
        try {
            if (null != payload) {
                log.info("Personal Medical Conditions before update : {}", medicalConditions);
                if (medicalConditions.isPresent()) {
                    medicalConditions.get().setDiseaseQuestionnaire(underwritingMapper.diseaseQuestionnaireResponseToEntity(updateDiseaseQuestionnaire(
                            medicalConditions.get().getDiseaseQuestionnaire().getDiseaseQuestionnaireId(), payload.getDiseaseQuestionnaire())));
                    ...
                    medicalConditions.get().setYearWhenFirstDiagnosisWasTaken(payload.getYearWhenFirstDiagnosisWasTaken());
                    personalMedicalConditionsRepository.save(medicalConditions.get());
                    log.info("Personal Medical Conditions after udpate : {}", medicalConditions);
                    return PersonalMedicalConditionsResponse.builder()
                            .personalMedicalConditionsId(medicalConditions.get().getPersonalMedicalConditionsId())
                            .diseaseQuestionnaire(findDiseaseQuestionnaireById(medicalConditions.get().getDiseaseQuestionnaire().getDiseaseQuestionnaireId()))
    ...
    public void deletePersonalMedicalConditionsById(String personalMedicalConditionsId) {
        Optional<PersonalMedicalConditions> personalMedicalConditions = personalMedicalConditionsRepository.findPersonalMedicalConditionsByPersonalMedicalConditionsId(personalMedicalConditionsId);
        log.info("Personal Medical Conditions to delete : {}", personalMedicalConditions);
