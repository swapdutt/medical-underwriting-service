...
public class MedicalConditionsService {
    ...
    public DiseaseQuestionnaireDto findDiseaseQuestionnaireById (String diseaseQuestionnaireId) {
        ...
        DiseaseQuestionnaire diseaseQuestionnaire = diseaseQuestionnaireRepository.
                findDiseaseQuestionnaireByDiseaseQuestionnaireId(diseaseQuestionnaireId).orElseThrow(() ->
                        new UnderwritingException("404", UnderwritingConstants.DISEASE_QUESTIONNAIRE_ID_NOT_FOUND, HttpStatus.NOT_FOUND));

        return DiseaseQuestionnaireDto.builder()
                .id(diseaseQuestionnaire.getId())
                .diseaseQuestionnaireId(diseaseQuestionnaire.getDiseaseQuestionnaireId())
                .question1(diseaseQuestionnaire.getQuestion1())
                .question2(diseaseQuestionnaire.getQuestion2())
                .question3(diseaseQuestionnaire.getQuestion3())
                .question4(diseaseQuestionnaire.getQuestion4())
                .question5(diseaseQuestionnaire.getQuestion5())
                .question6(diseaseQuestionnaire.getQuestion6())
                .question7(diseaseQuestionnaire.getQuestion7())
                .question8(diseaseQuestionnaire.getQuestion8())
                .question9(diseaseQuestionnaire.getQuestion9())
                .question10(diseaseQuestionnaire.getQuestion10())
                .question11(diseaseQuestionnaire.getQuestion11())
                .question12(diseaseQuestionnaire.getQuestion12())
                .build();
    ...
    public PersonalMedicalConditionsDto findPersonalMedicalConditionsById (String personalMedicalConditionsId) {
        ...
        PersonalMedicalConditions personalMedicalConditions = personalMedicalConditionsRepository.
                findPersonalMedicalConditionsByPersonalMedicalConditionsId(personalMedicalConditionsId).orElseThrow(() ->
                        new UnderwritingException("404", UnderwritingConstants.PERSONAL_MEDICAL_CONDITIONS_ID_NOT_FOUND, HttpStatus.NOT_FOUND));


        return PersonalMedicalConditionsDto.builder()
                .id(personalMedicalConditions.getId())
                .personalMedicalConditionsId(personalMedicalConditions.getPersonalMedicalConditionsId())
                .diseaseQuestionnaire(underwritingMapper.diseaseQuestionnaireToDiseaseQuestionnaireDto(personalMedicalConditions.getDiseaseQuestionnaire()))
                ...
                .yearWhenFirstDiagnosisWasTaken(personalMedicalConditions.getYearWhenFirstDiagnosisWasTaken())
                .build();
            ...
            if (null != dto) {
                ...
                if (diseaseQuestionnaire.isPresent()) {
                    ...
                    return DiseaseQuestionnaireDto.builder()
                            ...
                            .question1(questionnaire.getQuestion1())
                            .question2(questionnaire.getQuestion2())
                            .question3(questionnaire.getQuestion3())
                            .question4(questionnaire.getQuestion4())
                            .question5(questionnaire.getQuestion5())
                            .question6(questionnaire.getQuestion6())
                            .question7(questionnaire.getQuestion7())
                            .question8(questionnaire.getQuestion8())
                            .question9(questionnaire.getQuestion9())
                            .question10(questionnaire.getQuestion10())
                            .question11(questionnaire.getQuestion11())
                            .question12(questionnaire.getQuestion12())
                            .build();
                }
            }
        } catch (UnderwritingException e) {
        ...
        try {
            if (null != dto) {
                ...
                if (labTests.isPresent()) {
                    ...
                    return underwritingMapper.labTestsToLabTestsDto(labTestsRepository.save(underwritingMapper.labTestsDtoToLabTests(dto)));
                }
            }
        } catch (UnderwritingException e) {
            throw new UnderwritingException("400", UnderwritingConstants.BAD_REQUEST, HttpStatus.BAD_REQUEST);
        ...
        try {
            if (null != dto) {
                Optional<PersonalMedicalConditions> personalMedicalConditions = personalMedicalConditionsRepository
                        .findPersonalMedicalConditionsByPersonalMedicalConditionsId(dto.getPersonalMedicalConditionsId());
                if (personalMedicalConditions.isPresent()) {
                    ...
                    return PersonalMedicalConditionsDto.builder()
                            ...
                            .diseaseQuestionnaire(underwritingMapper.diseaseQuestionnaireToDiseaseQuestionnaireDto(pmc.getDiseaseQuestionnaire()))
                            .nameOfDisease(pmc.getNameOfDisease())
                            .typeOfDisease(pmc.getTypeOfDisease())
                            .typeOfTreatment(pmc.getTypeOfTreatment())
                            .currentStatusOfDisease(pmc.getCurrentStatusOfDisease())
                            .typeOfComplication(pmc.getTypeOfComplication())
                            .typeOfBiopsy(pmc.getTypeOfBiopsy())
                            .lastConsultationDate(pmc.getLastConsultationDate())
                            .yearWhenFirstDiagnosisWasTaken(pmc.getYearWhenFirstDiagnosisWasTaken())
                            .build();
                }
            }
        } catch (UnderwritingException e) {
