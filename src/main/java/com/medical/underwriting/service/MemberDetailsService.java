...
public class MemberDetailsService {
    ...
    public LifestyleDetailsDto findLifestyleDetailsById (String lifestyleDetailsId) {
        ...
        LifestyleDetails lifestyleDetails = lifestyleRepository.
                findLifestyleDetailsByLifestyleDetailsId(lifestyleDetailsId).orElseThrow(() ->
                        new UnderwritingException("404", UnderwritingConstants.LIFESTYLE_DETAILS_ID_NOT_FOUND, HttpStatus.NOT_FOUND));

        return LifestyleDetailsDto.builder()
                .id(lifestyleDetails.getId())
                ...
                .frequencyOfAlcoholConsumptionPerDay(lifestyleDetails.getFrequencyOfAlcoholConsumptionPerDay())
                .build();
    ...
    public MedicalConditionsDetailsDto findMedicalConditionsDetailsById (String medicalConditionsDetailsId) {
        ...
        try {
            if (null != medicalConditionsDetailsId) {
                ...
                return medicalConditionsDetails.map(underwritingMapper::medicalConditionsDetailsToMedicalConditionsDetailsDto).orElse(null);
            }
        } catch (UnderwritingException e) {
            ...
            if (null != dto) {
                ...
                if (memberDetails.isPresent()) {
                    ...
                    return underwritingMapper
                            .memberDetailsToMemberDetailsDto(memberDetailsRepository
                                    .save(underwritingMapper.memberDetailsDtoToMemberDetails(dto)));
                }
            }
        } catch (UnderwritingException e) {
    ...
    public LifestyleDetailsDto createLifestyleDetails (LifestyleDetailsDto dto) {
        ...
        try {
            if (null != dto) {
                Optional<LifestyleDetails> lifestyleDetails = lifestyleRepository.findLifestyleDetailsByLifestyleDetailsId(dto.getLifestyleDetailsId());
                if (lifestyleDetails.isPresent()) {
                    ...
                    LifestyleDetails lifestyle = lifestyleRepository.save(underwritingMapper.lifestyleDetailsDtoToLifestyleDetails(dto));
                    return LifestyleDetailsDto.builder()
                            .id(lifestyle.getId())
                            .lifestyleDetailsId(lifestyle.getLifestyleDetailsId())
                            .amountOfTobaccoProductsConsumptionPerDay(lifestyle.getAmountOfTobaccoProductsConsumptionPerDay())
        ...
        try {
            if (null != dto) {
                ...
                if (medicalConditionsDetails.isPresent()) {
                    ...
                    return underwritingMapper
                            .medicalConditionsDetailsToMedicalConditionsDetailsDto(medicalConditionsDetailsRepository
                                    .save(underwritingMapper.medicalConditionsDetailsDtoToMedicalConditionsDetails(dto)));
                }
            }
        } catch (UnderwritingException e) {
            throw new UnderwritingException("400", UnderwritingConstants.BAD_REQUEST, HttpStatus.BAD_REQUEST);
