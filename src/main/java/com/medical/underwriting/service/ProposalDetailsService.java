...
public class ProposalDetailsService {
    ...
    public PaymentDetailsDto findPaymentDetailsById (String paymentDetailsId) {
        ...
        return PaymentDetailsDto.builder()
                ...
                .declarationOfPayor(paymentDetails.getDeclarationOfPayor())
                .build();
    ...
    public ProposerDetailsDto findProposerDetailsById (String proposerDetailsId) {
        ...
        ProposerDetails proposerDetails = proposerDetailsRepository.
                findProposerDetailsByProposerDetailsId(proposerDetailsId).orElseThrow(() ->
                        new UnderwritingException("404", UnderwritingConstants.PROPOSER_DETAILS_ID_NOT_FOUND, HttpStatus.NOT_FOUND));

        return ProposerDetailsDto.builder()
                .id(proposerDetails.getId())
                .proposerDetailsId(proposerDetails.getProposerDetailsId())
                .firstName(proposerDetails.getFirstName())
                .middleName(proposerDetails.getMiddleName())
                .lastName(proposerDetails.getLastName())
                ...
                .occupation(proposerDetails.getOccupation())
                .sumInsured(proposerDetails.getSumInsured())
                .riskStartDate(proposerDetails.getRiskStartDate())
                .employer(proposerDetails.getEmployer())
                .designation(proposerDetails.getDesignation())
                .build();
        ...
        try {
            if (null != dto) {
                ...
                if (paymentDetails.isPresent()) {
                    ...
                    PaymentDetails payment = paymentDetailsRepository.save(underwritingMapper.paymentDetailsDtoToPaymentDetails(dto));
                    return PaymentDetailsDto.builder()
                            .id(payment.getId())
                            .paymentDetailsId(payment.getPaymentDetailsId())
                            .nameOfPayor(payment.getNameOfPayor())
                            .modeOfPayment(payment.getModeOfPayment())
                            .relationshipOfPayor(payment.getRelationshipOfPayor())
                            .amountPaid(payment.getAmountPaid())
                            .dateOfInstrument(payment.getDateOfInstrument())
                            .dateOfReceipt(payment.getDateOfReceipt())
                            .branchLocation(payment.getBranchLocation())
                            .idProofOfPayor(payment.getIdProofOfPayor())
                            .declarationOfPayor(payment.getDeclarationOfPayor())
                            .build();
                }
            }
        } catch (UnderwritingException e) {
    ...
    public ProposerDetailsDto createProposerDetails (ProposerDetailsDto dto) {
        ...
        try {
            if (null != dto) {
                Optional<ProposerDetails> proposerDetails = proposerDetailsRepository.findProposerDetailsByProposerDetailsId(dto.getProposerDetailsId());
                if (proposerDetails.isPresent()) {
                    ...
                    ProposerDetails proposer = proposerDetailsRepository.save(underwritingMapper.proposerDetailsDtoToProposerDetails(dto));
                    return ProposerDetailsDto.builder()
                            .id(proposer.getId())
                            .proposerDetailsId(proposer.getProposerDetailsId())
                            .firstName(proposer.getFirstName())
                            .middleName(proposer.getMiddleName())
                            .lastName(proposer.getLastName())
                            .nationality(proposer.getNationality())
                            .countryOfResidence(proposer.getCountryOfResidence())
                            .maritalStatus(proposer.getMaritalStatus())
                            .annualIncome(proposer.getAnnualIncome())
                            .proposerPolicyHolderFlag(proposer.getProposerPolicyHolderFlag())
                            .nomineeRelationship(proposer.getNomineeRelationship())
                            .profession(proposer.getProfession())
                            ...
                            .occupation(proposer.getOccupation())
                            .sumInsured(proposer.getSumInsured())
                            .riskStartDate(proposer.getRiskStartDate())
                            .employer(proposer.getEmployer())
                            .designation(proposer.getDesignation())
                            .build();
                }
            }
        } catch (UnderwritingException e) {
    ...
    public ProposalDetailsDto createProposalDetails (ProposalDetailsDto dto) {
        ...
        try {
            if (null != dto) {
                Optional<ProposalDetails> proposalDetails = proposalDetailsRepository.findProposalDetailsByProposalDetailsId(dto.getProposalDetailsId());
                if (proposalDetails.isPresent()) {
                    ...
                    return underwritingMapper
                            .proposalDetailsToProposalDetailsDto(proposalDetailsRepository
